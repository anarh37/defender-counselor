...
const allQuestions = {
  "피해자": [
    ...
    [
      ...
      "누군가 네 편에서 이야기해 주거나 도와줬으면 어떻게 달라졌을 것 같아?",
      "비슷한 상황에 처한 다른 친구가 있다면, 네 경험을 토대로 어떤 조언이나 위로를 해 주고 싶어?"
    ],
    [
  ...
  "방관자": [
    [
      ...
      "처음와 지금의 생각에 어떤 차이가 있는지 말해 줄 수 있어?"
    ],
    [
    ...
    [
      ...
      "만약 네가 피해자의 입장이었다면, 주변 친구들에게 어떻게 해  주기를 기대했을까?",
      "혹시 후회하는 마음이 있다면 말해 줄 수 있어?"
    ],
    [
      "다음에 또 그런 상황이 생기면, 어떻게 행동하고 싶어?",
      "누군가 힘들어하는 걸 봤을 때, 어떤 말을 해 주면 좋을까?",
      "그 친구의 자리에 네 가장 친한 친구가 있었다면 어떻게 했을 것 같아?",
      "네가 할 수 있는 '작은 방어자 행동'은 뭐가 있을까?",
      "만약 그때와 같은 상황에서 내가 옆에 있어 준다면, 같이 말해 줄 수 있을까?",
  ...
  "가해자": [
    ...
    [
      ...
      "앞으로 내가 할 수 있는 '작은 실천' 한 가지를 말해 줄래?",
  ...
  "방어자": [
    ...
    [
      "피해 친구를 어떻게 도와주었어? 그 방법을 선택한 이유를 말해 줄래?",
      "다른 친구들도 용기를 낼 수 있도록 어떻게 도울 수 있을까?"
    ],
    [
      "다음에도 비슷한 상황이 생긴다면 또 용기 낼 수 있을까?",
